...
const API_INDEX_INTRO =
  'The complete API reference for `obsidian-integration-testing`, generated from the library\'s TSDoc. '
  + 'The modules below group the reference by source module; every name is imported from the package '
  + 'root (e.g. `import { evalInObsidian } from \'obsidian-integration-testing\';`).';
